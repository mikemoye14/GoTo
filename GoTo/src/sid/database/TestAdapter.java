...
{ 
    ...
    { 
 	...
 	public String getData(String table, String id, String columnName){
 		
 		 try 
 	     { 
 		 String sql ="SELECT "+columnName+" FROM "+table+" WHERE _id='"+id+"'";
 	...
 	/*
 	public Cursor getBuildingName(String table, String id){
 		return Cursor a;
 	}
 	*/
